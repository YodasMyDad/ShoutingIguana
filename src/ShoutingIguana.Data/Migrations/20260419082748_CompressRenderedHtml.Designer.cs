...
namespace ShoutingIguana.Data.Migrations
{
    ...
    [Migration("20260419082748_CompressRenderedHtml")]
    partial class CompressRenderedHtml
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoutingIguana.Core.Models.ReportRow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ShoutingIguana.Core.Models.ReportSchema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("ReportSchemas", (string)null);
                });
            ...
            modelBuilder.Entity("ShoutingIguana.Core.Models.Url", b =>
                {
                    ...
                    b.Property<byte[]>("RenderedHtmlGzip")
                        .HasColumnType("BLOB");
            ...
            modelBuilder.Entity("ShoutingIguana.Core.Models.ReportRow", b =>
                {
                    ...
                    b.HasOne("ShoutingIguana.Core.Models.ReportSchema", "ReportSchema")
                        .WithMany("ReportRows")
                        .HasForeignKey("TaskKey")
                        .HasPrincipalKey("TaskKey")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
